<nav x-data="{ open: false }" x-on:keydown.window.escape="open = false" class="bg-indigo-700">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline">
              ...
              <a href="../givings" class="ml-4 px-3 py-2 rounded-md text-sm font-medium {{ request()->is('givings') ? 'text-white  bg-indigo-800 focus:outline-none focus:text-white focus:bg-indigo-600' : 'text-indigo-50 hover:text-white hover:bg-indigo-600 focus:outline-none focus:text-white focus:bg-indigo-600' }}">My Giving</a>
    ...
    <div x-bind:class="{'block': open, 'hidden': !open}" class="hidden md:hidden">
      <div class="px-2 pt-2 pb-3 sm:px-3">
        ...
        <a href="../givings" class="mt-1 block px-3 py-2 rounded-md text-base font-medium {{ request()->is('givings') ? 'text-white bg-indigo-800 focus:outline-none focus:text-white focus:bg-gray-700' : 'text-indigo-200 hover:text-white hover:bg-indigo-600 focus:outline-none focus:text-white focus:bg-indigo-600' }}">My Giving</a>
        <a href="#" v-on:click.prevent="salvation()"  class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-orange-200 hover:text-white hover:bg-indigo-600 focus:outline-none focus:text-white focus:bg-indigo-600">Accept the Lord Jesus</a>
