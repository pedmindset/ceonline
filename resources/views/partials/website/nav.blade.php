        ...
        <div>
          ...
          <div class="mt-3 text-center sm:mt-5">
            ...
            <div class="mt-2">
              ...
              <a class="ml-4 pt-8 pb- rounded-md text-sm font-medium text-indigo-600 hover:text-white hover:bg-indigo-900 focus:outline-none focus:text-white focus:bg-indigo-900" href="https://wa.me/?text={{ url('/') }}" class="social-button " id=""><i class="text-5xl lab la-whatsapp"></i></span></a>   
            </div>
          </div>
