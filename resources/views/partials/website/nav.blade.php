<nav x-data="{ open: false }" x-on:keydown.window.escape="open = false" class="bg-indigo-700">
    ...
    <div x-bind:class="{'block': open, 'hidden': !open}" class="hidden md:hidden">
      <div class="px-2 pt-2 pb-3 sm:px-3">
        ...
        <a href="#" v-on:click.prevent="salvation()"  class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-orange-200 hover:text-white hover:bg-indigo-600 focus:outline-none focus:text-white focus:bg-indigo-600">Get Born Again</a>
